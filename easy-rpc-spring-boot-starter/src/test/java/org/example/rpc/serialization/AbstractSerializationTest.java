...
import org.example.rpc.common.URL;
import org.example.rpc.serialization.model.AnimalEnum;
import org.example.rpc.serialization.model.BizException;
import org.example.rpc.serialization.model.BizExceptionNoDefaultConstructor;
import org.example.rpc.serialization.model.media.Image;
import org.example.rpc.serialization.model.media.Media;
import org.example.rpc.serialization.model.media.MediaContent;
import org.example.rpc.serialization.model.person.*;
...
public abstract class AbstractSerializationTest {
    ...
    public void test_UtfString() throws Exception {
        ObjectOutput objectOutput = serialization.serialize(byteArrayOutputStream);
        objectOutput.writeUTF("123ceshi测试");
        objectOutput.flushBuffer();
        ...
        assertEquals("123ceshi测试", deserialize.readUTF());
    ...
    public void test_Bytes() throws Exception {
        ObjectOutput objectOutput = serialization.serialize(byteArrayOutputStream);
        objectOutput.writeBytes("123ceshi测试".getBytes());
        objectOutput.flushBuffer();
        ...
        assertArrayEquals("123ceshi测试".getBytes(), deserialize.readBytes());
    ...
    public void test_BytesRange() throws Exception {
        ObjectOutput objectOutput = serialization.serialize(byteArrayOutputStream);
        objectOutput.writeBytes("123ceshi测试".getBytes(), 1, 4);
        objectOutput.flushBuffer();
        ...
        System.arraycopy("123ceshi测试".getBytes(), 1, expectedArray, 0, expectedArray.length);
    ...
    public void test_BizException_WithType() throws Exception {
        ...
        BizException read = deserialize.readObject(BizException.class);
        assertEquals("Hello", read.getMessage());
    }
    ...
    public void test_BizExceptionNoDefaultConstructor_WithType() throws Exception {
        ...
        BizExceptionNoDefaultConstructor read = deserialize.readObject(BizExceptionNoDefaultConstructor.class);
        assertEquals("Hello", read.getMessage());
    }
    ...
    public void test_URL_mutable_withType() throws Exception {
        URL data = URL.valueOf("rpc://admin:hello1234@10.20.130.230:20880/context/path?version=1.0.0&application=morgan&noValue");
        ...
        URL actual = deserialize.readObject(URL.class);
